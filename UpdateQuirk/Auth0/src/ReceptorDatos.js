...
const ReceptorDatos = () => {
  ...
  const translateToPython = async (id, url) => {
    ...
    try {
      ...
      const awsResponse = await axios.post('http://ec2-54-155-193-167.eu-west-1.compute.amazonaws.com:8083/code/aws', 
        { 
          url: url 
      ...
      const ibmResponse = await axios.post('http://ec2-54-155-193-167.eu-west-1.compute.amazonaws.com:8083/code/ibm', 
        { 
          url: url 
        }, // La URL como un objeto JSON
        {
